...
The \indcmdt{spline} fits a spline through data from a file.  For example:
...
same way as for the {\tt plot} command, the \indmodt{index}, \indmodt{every},
\indmodt{using} and \indmodt{select} modifiers can also be used to bin
