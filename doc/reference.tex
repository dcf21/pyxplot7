...
\section{histogram}\index{histogram command@\texttt{histogram} command}
...
\section{history}\index{history command@\texttt{history} command}
...
`\texttt{pyxplot.eps}'.  This terminal produces encapsulated postscript
...
\section{tabulate}\index{tabulate command@\texttt{tabulate} command}
