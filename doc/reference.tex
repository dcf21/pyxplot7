...
\section{arrow}\index{arrow command@{\tt arrow} command}
...
\section{cd}\index{cd command@{\tt cd} command}
...
\section{clear}\index{clear command@{\tt clear} command}
...
\section{delete}\index{delete command@{\tt delete} command}
...
\section{edit}\index{edit command@{\tt edit} command}
...
\section{eps}\index{eps command@{\tt eps} command}
...
\section{exit}\index{exit command@{\tt exit} command}
...
\section{fit}\index{fit command@{\tt fit} command}
...
\section{help}\index{help command@{\tt help} command}
...
\section{histogram}\index{histogram command@{\tt histogram} command}
...
\section{history}\index{history command@{\tt history} command}
...
\section{jpeg}\index{jpeg command@{\tt jpeg} command}
...
\section{load}\index{load command@{\tt load} command}
...
command files matching the given wildcard are executed, for example:
...
\section{move}\index{move command@{\tt move} command}
...
\section{plot}\index{plot command@{\tt plot} command}
...
\section{print}\index{print command@{\tt print} command}
...
\section{pwd}\index{pwd command@{\tt pwd} command}
...
\section{?}\index{? command@{\tt ?} command}
...
\section{quit}\index{quit command@{\tt quit} command}
...
\section{refresh}\index{refresh command@{\tt refresh} command}
...
\section{replot}\index{replot command@{\tt replot} command}
...
\section{reset}\index{reset command@{\tt reset} command}
...
\section{save}\index{save command@{\tt save} command}
...
\section{set}\index{set command@{\tt set} command}
...
\subsection{arrow}\index{set arrow command@{\tt set arrow} command}
...
\subsection{autoscale}\index{set autoscale command@{\tt set autoscale} command}
...
\subsection{axescolour}\index{set axescolour command@{\tt set axescolour} command}
...
\subsection{axis}\index{set axis command@{\tt set axis} command}
...
\subsection{backup}\index{set backup command@{\tt set backup} command}
...
\subsection{bar}\index{set bar command@{\tt set bar} command}
...
\subsection{binorigin}\index{set binorigin command@{\tt set binorigin} command}
...
\subsection{binwidth}\index{set binwidth command@{\tt set binorigin} command}
...
\subsection{boxfrom}\index{set boxfrom command@{\tt set boxfrom} command}
...
\subsection{boxwidth}\index{set boxwidth command@{\tt set boxwidth} command}
...
\subsection{data style}\index{set data style command@{\tt set data style} command}

See `{\tt set style data}'.

\subsection{display}\index{set display command@{\tt set display} command}
...
\subsection{dpi}\index{set dpi command@{\tt set dpi} command}
...
\subsection{fontsize}\index{set fontsize command@{\tt set fontsize} command}
...
\subsection{function style}\index{set function style command@{\tt set function style} command}

See `{\tt set style function}'.

\subsection{grid}\index{set grid command@{\tt set grid} command}
...
\subsection{gridmajcolour}\index{set gridmajcolour command@{\tt set gridmajcolour} command}
...
\subsection{gridmincolour}\index{set gridmincolour command@{\tt set gridmincolour} command}
...
\subsection{key}\index{set key command@{\tt set key} command}
...
\subsection{keycolumns}\index{set keycolumns command@{\tt set keycolumns} command}
...
\subsection{label}\index{set label command@{\tt set label} command}
...
\subsection{linestyle}\index{set linestyle command@{\tt set linestyle} command}
...
\subsection{linewidth}\index{set linewidth command@{\tt set linewidth} command}
...
\subsection{logscale}\index{set logscale command@{\tt set logscale} command}
...
\subsection{multiplot}\index{set multiplot command@{\tt set multiplot} command}
...
\subsection{mxtics}\index{set mxtics command@{\tt set mxtics} command}

See {\tt set xtics}.

\subsection{mytics}\index{set mytics command@{\tt set mytics} command}

See {\tt set xtics}.

\subsection{noarrow}\index{set noarrow command@{\tt set noarrow} command}
...
\subsection{noaxis}\index{set noaxis command@{\tt set noaxis} command}
...
\subsection{nobackup}\index{set nobackup command@{\tt set nobackup} command}

See {\tt backup}.


\subsection{nodisplay}\index{set nodisplay command@{\tt set nodisplay} command}

See {\tt display}.


\subsection{nogrid}\index{set nogrid command@{\tt set nogrid} command}
...
\subsection{nokey}\index{set nokey command@{\tt set nokey} command}
...
\subsection{nolabel}\index{set nolabel command@{\tt set nolabel} command}
...
\subsection{nolinestyle}\index{set nolinestyle command@{\tt set nolinestyle} command}
...
\subsection{nologscale}\index{set nologscale command@{\tt set nologscale} command}
...
\subsection{nomultiplot}\index{set nomultiplot command@{\tt set nomultiplot} command}
...
\subsection{notitle}\index{set notitle command@{\tt set notitle} command}
...
\subsection{noxtics}\index{set noxtics command@{\tt set noxtics} command}
...
\subsection{noytics}\index{set noytics command@{\tt set noytics} command}

See {\tt set noxtics}.


\subsection{origin}\index{set origin command@{\tt set origin} command}
...
\subsection{output}\index{set output command@{\tt set output} command}
...
\subsection{palette}\index{set palette command@{\tt set palette} command}
...
\subsection{papersize}\index{set papersize command@{\tt set papersize} command}
...
\subsection{pointlinewidth}\index{set pointlinewidth command@{\tt set pointlinewidth} command}
...
\subsection{pointsize}\index{set pointsize command@{\tt set pointsize} command}
...
\subsection{preamble}\index{set preamble command@{\tt set preamble} command}
...
\subsection{samples}\index{set samples command@{\tt set samples} command}
...
\subsection{size}\index{set size command@{\tt set size} command}
...
\subsection{style}\index{set style command@{\tt set style} command}
...
\subsection{terminal}\index{set terminal command@{\tt set terminal} command}
...
\subsection{textcolour}\index{set textcolour command@{\tt set textcolour} command}
...
\subsection{texthalign}\index{set texthalign command@{\tt set texthalign} command}
...
\subsection{textvalign}\index{set textvalign command@{\tt set textvalign} command}
...
\subsection{title}\index{set title command@{\tt set title} command}
...
\subsection{width}\index{set width command@{\tt set width} command}
...
\subsection{xlabel}\index{set xlabel command@{\tt set xlabel} command}
...
\subsection{xrange}\index{set xrange command@{\tt set xrange} command}
...
\subsection{xticdir}\index{set xticdir command@{\tt set xticdir} command}
...
\subsection{xtics}\index{set xtics command@{\tt set xtics} command}
...
\subsection{ylabel}\index{set ylabel command@{\tt set ylabel} command}

See {\tt xlabel}.


\subsection{yrange}\index{set yrange command@{\tt set yrange} command}

See {\tt xrange}.
   

\subsection{yticdir}\index{set yticdir command@{\tt set yticdir} command}

See {\tt xticdir}.


\subsection{ytics}\index{set ytics command@{\tt set ytics} command}

See {\tt xtics}.

\section{show}\index{show command@{\tt show} command}
...
\section{spline}\index{spline command@{\tt spline} command}
...
\section{tabulate}\index{tabulate command@{\tt tabulate} command}
...
\section{text}\index{text command@{\tt text} command}
...
\section{undelete}\index{undelete command@{\tt undelete} command}
...
\section{unset}\index{unset command@{\tt unset} command}
