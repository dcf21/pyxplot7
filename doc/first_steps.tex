...
\noindent Likewise, datafiles can be plotted with a line connecting the data
points:
...
and $y$-coordinates of each data point, plus the size of the vertical errorbar
on that data point. By default, the first three columns of the datafile are
