...
\end{center}
\caption{A gallery of the various bar chart styles which PyXPlot can produce. See the text for more details.}
...
\end{center}
\caption{A second gallery of the various bar chart styles which PyXPlot can produce. See the text for more details.}
...
By default, when graphic output is sent to a file -- i.e.\ a postscript file or
