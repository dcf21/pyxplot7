...
\index{set command@{\tt set} command}
...
preamble} command.\index{set preamble command@{\tt set preamble} command}
\end{itemize}
...
{\tt ASPECT} & {\bf Possible values:} Any floating-point number.
                   ...
                   {\bf Analogous set command:} {\tt set size ratio}\index{set size ratio command@{\tt set size ratio} command}
...
{\tt AXESCOLOUR} & {\bf Possible values:} Any recognised colour.
                   ...
                   {\bf Analogous set command:} {\tt set axescolour}\index{set axescolour command@{\tt set axescolour} command}

                   Sets the colour of axis lines and ticks.
                   \\
{\tt BACKUP} & {\bf Possible values:} ON / OFF

                   {\bf Analogous set command:} {\tt set backup}\index{set backup command@{\tt set backup} command}
...
{\tt BAR}     & {\bf Possible values:}  Any floating-point number.
                   ...
                   {\bf Analogous set command:} {\tt set bar}\index{set bar command@{\tt set bar} command}
...
{\tt BINORIGIN} & {\bf Possible values:} Any floating-point number
                   ...
                   the {\tt histogram} command originate.
                   \\
{\tt BINWIDTH} & {\bf Possible values:} Any floating-point number

                   {\bf Analogous set command:} {\tt set binwidth}

                   Sets the widths of the bins used by the {\tt histogram}
                   command.
                   \\
{\tt BOXFROM} & {\bf Possible values:} Any floating-point number.

                   {\bf Analogous set command:} {\tt set boxfrom}\index{set boxfrom command@{\tt set boxfrom} command}
...
{\tt BOXWIDTH} & {\bf Possible values:} Any floating-point number.
                   ...
                   {\bf Analogous set command:} {\tt set boxwidth}\index{set boxwidth command@{\tt set boxwidth} command}
...
{\tt DATASTYLE} & {\bf Possible values:} Any plot style. 
                   ...
                   {\bf Analogous set command:} {\tt set data style}\index{set data style command@{\tt set data style} command}
                   
                   Sets the plot style used by default when plotting datafiles.
                   \\
{\tt DISPLAY} & {\bf Possible values:} ON / OFF

                   {\bf Analogous set command:} {\tt set display}\index{set display command@{\tt set display} command}

                   When set to `ON', no output is produced until the {\tt set display} command is issued. This is useful for speeding up scripts which produce large multiplots; see Section~\ref{set_display} for more details.
                   \\
